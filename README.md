...
An analysis-ready CSV (e.g. `InputData/...-IncomeNormalized-analysis-ready.csv`), or the NoOutliers CSV if you want cleaned-data relationships.
...
6) Script: `scripts/stratified_statistical_analysis.py`
